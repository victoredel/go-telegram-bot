...
type Chat struct {
	...
	emoji_status_expiration_date            int             //Optional. Expiration date of the emoji status of the chat or the other party in a private chat, in Unix time, if any. Returned only in getChat.
...
type ReplyParameters struct {
	...
	chat_id                     int             //Optional. If the message to be replied to is from a different chat, unique identifier for the chat or username of the channel (in the format @channelusername)
...
type PollAnswer struct {
	...
	option_ids []int  //0-based identifiers of chosen answer options. May be empty if the vote was retracted.
}
...
type Location struct {
	...
	horizontal_accuracy    float64 //Optional. The radius of uncertainty for the location, measured in meters; 0-1500
...
type InputMedia struct {
	...
	width              int    //Optional. Video/Animation width
	height             int    //Optional. Video/Animation height
	duration           int    //Optional. Video/Animation/audio duration in seconds
